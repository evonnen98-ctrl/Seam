          ...
          <div className="h-full overflow-y-auto flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center px-5 sm:px-10 py-12">
              <div className="w-full max-w-lg flex flex-col items-center text-center">
                ...
                {/* Greeting */}
                <h1 style={{ opacity: visible ? 1 : 0, transition: "opacity 0.5s ease 0s", fontFamily: "'Clash Display', var(--font-inter)", fontSize: "clamp(2.1rem, 13.2vw, 4.8rem)", fontWeight: 700, color: "#1a1a1a", letterSpacing: "-0.03em", marginBottom: "0.5rem", lineHeight: 1.1, whiteSpace: "nowrap" }}>
                  {getGreeting()}
                </h1>
